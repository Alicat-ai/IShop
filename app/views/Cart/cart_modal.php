    ...
    <div class="table-responsive cart-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $item['qty']?></td>
                <td><?= $item['price']?></td>
                <td><a href="cart/delete?id=<?= $id?>" data-id="<?= $id ?>" class="del-item"><i class="far fa-trash-alt"></a></td>
            </tr>
            <?php endforeach; ?>
            <tr>
...
<div class="modal-footer">
    ...
    <?php if (!empty($_SESSION['cart'])):?>
    <a href="cart/view" class="btn btn-primary"><?php __('tpl_cart_btn_order'); ?></button>
